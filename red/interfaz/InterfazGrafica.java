...
public class InterfazGrafica extends JFrame {
    ...
    public InterfazGrafica() {
        ...
        JButton pingButton = crearBoton("Realizar Ping", new Color(60, 179, 113),
                e -> realizarPing((String) pingComboBox.getSelectedItem()));
        ...
        JButton tracerouteButton = crearBoton("Realizar Traceroute", new Color(255, 105, 180),
                e -> realizarTraceroute((String) tracerouteComboBox1.getSelectedItem(),
                        (String) tracerouteComboBox2.getSelectedItem()));
        ...
        outputArea.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10),
    ...
    // Metodo para cargar datos de archivos y llenar los ComboBox con las IPs de los
    // equipos
